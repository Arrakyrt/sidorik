...
<?php
    $page_link = 3;//Кол-во отображаемых страниц
    $pnumber = 10;//Кол-во позиций на странице
    $obj = new pager_mysql($tbl_product, "", "ORDER BY id DESC", $pnumber, $page_link);
    $news = $obj -> get_page($news);
    echo $obj;
    if(!empty($news)){
?>
      ...
      for($i=0; $i<count($news); $i++) {
        ...
        echo "<tr>
          ...
          <td class='menu' valign='top'>".$showhide."
            ...
            <img src='../utils/img/kedit.gif' border=0 align='absmiddle'/>
            Редактировать </a>
